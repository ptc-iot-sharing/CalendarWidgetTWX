# Calendar widget using webpack and typescript

This contains an example that can also act as a starter kit for building widget using modern web developement techniques like [webpack](https://webpack.js.org/) and [typescript](https://www.typescriptlang.org/) and [babel](https://babeljs.io/).
...
│   │   Calendar.ide.ts     // source file for the Composer section of the widget
│   │   Calendar.runtime.ts // source file for the Runtime section of the widget
...
In order to build this project you need to do the following:


1. Run `npm install`. This will install the development dependencies for this project.
2. Start working on your widget.
